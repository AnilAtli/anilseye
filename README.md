...
### A real-time spatial-intelligence console in your browser — public sources, live signals, one explorable planet.
...
_The world, in one view._

Anıl's Eye is an independent, branded build based on the MIT-licensed [God's Eye View](https://github.com/bilawalsidhu/gods-eye-view) project by Bilawal Sidhu and contributors. The upstream architecture, source attribution, third-party licenses, safety notes, and media provenance are preserved in this repository.
